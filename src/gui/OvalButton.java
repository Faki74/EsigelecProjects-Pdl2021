...
public class OvalButton extends JButton implements MouseListener, MouseMotionListener {	
     ...
     */
    public OvalButton(String text,int shape, int orientation) {
        this(text,shape, orientation, Color.WHITE, Color.LIGHT_GRAY, Color.BLACK, Color.RED);
    }
     ...
     */
    public OvalButton(String text,int shape, int orientation, Color colorNormal, Color colorHighlighted, Color colorBorderNormal, Color colorBorderHighlighted) {
        super(text);
